...
for section in branch_sections:
    ...
    if location_link and "onclick" in location_link.attrs:
        ...
        # Extract phone number between the last pair of quotes
        phone_start = onclick_content.rfind(",") + 2  # Start after last comma
        phone_end = onclick_content.rfind("'")  # End at the last quote
